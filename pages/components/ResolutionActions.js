...
export default function ResolutionActions () {
  ...
  const saveResolution = () => addDoc(dbInstance, { resolutionText: resolutionText })
    ...
    <>
      ...
      { isInputVisible && (
        <div className='flex flex-col gap-2'>
          ...
          />
          <button className='w-60 h-8 cursor-pointer bg-rose-800 text-white' onClick={ saveResolution }>Save</button>
        </div>
      ) }
    </>
  )
